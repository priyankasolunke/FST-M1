...

{
	...
	public void beforeClass() throws MalformedURLException
	{
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.view.View[1]/android.view.View[6]/android.view.View"))).click();
		
		//driver.findElementByXPath("//android.view.View[3]/android.view.View[19]/android.view.View").click();
	}
	...
	{
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.webkit.WebView/android.view.View[1]/android.view.View[5]/android.widget.Button"))).click();
